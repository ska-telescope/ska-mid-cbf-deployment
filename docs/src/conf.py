...
htmlhelp_basename = 'SKA_MidCBF_Deployment'
...
latex_documents = [
    (master_doc, 'SKA_MidCbf_Deployment.tex', 'SKA Mid.CBF Deployment Documentation',
     '{{author}}', 'manual'),
]
...
man_pages = [
    (master_doc, 'SKA_MidCbf_Deployment', 'SKA Mid.CBF Deployment Documentation',
     ['{{author}}'], 1)
]
...
texinfo_documents = [
    (master_doc, 'SKA_MidCbf_Deployment', 'SKA Mid.CBF Deployment Documentation',
     '{{author}}', 'SKA_MidCbf_Deployment', 'Mid.CBF Deployment',
     'Miscellaneous'),
]
